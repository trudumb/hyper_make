...
mod tests {
    ...
    fn test_additive_spread_multiplier_vs_multiplicative() {
        ...
        let _signals = IntegratedSignals {
            informed_flow_spread_mult: 1.5,
            gating_spread_mult: 1.5,
            cross_venue_spread_mult: 1.5,
            ..Default::default()
        };
    ...
    fn test_additive_spread_cap_enforced() {
        ...
        let _signals = IntegratedSignals {
            ...
            informed_flow_spread_mult: 3.0,
            gating_spread_mult: 3.0,
            cross_venue_spread_mult: 3.0,
            ..Default::default()
        };
    ...
    fn test_inventory_skew_disabled_config() {
        let config = SignalIntegratorConfig {
            use_inventory_skew: false,
            use_signal_skew: false,
            ..Default::default()
        };
