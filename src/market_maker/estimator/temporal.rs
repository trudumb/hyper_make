...
mod tests {
    ...
    fn test_funding_magnitude_elevated() {
        ...
        assert!(!features.is_funding_magnitude_elevated()); // Not > 1.0
        ...
        assert!(!features_extreme.is_funding_magnitude_elevated());
