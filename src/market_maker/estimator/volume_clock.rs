//! Volume clock for normalized economic sampling.
//!
//! Implements adaptive volume-based sampling to normalize trading data
//! by economic activity rather than wall-clock time.
