...
impl MockEstimator {
    ...
    pub fn with_params(sigma: f64, kappa: f64) -> Self {
        Self { sigma, kappa, is_warmed: true }
    }
}

impl MarketEstimator for MockEstimator {
    fn sigma_clean(&self) -> f64 { self.sigma }
    fn sigma_total(&self) -> f64 { self.sigma }
    fn sigma_effective(&self) -> f64 { self.sigma }
    fn volatility_regime(&self) -> VolatilityRegime { VolatilityRegime::Normal }
    fn kappa(&self) -> f64 { self.kappa }
    fn kappa_bid(&self) -> f64 { self.kappa }
    fn kappa_ask(&self) -> f64 { self.kappa }
    fn arrival_intensity(&self) -> f64 { 1.0 }
    fn liquidity_gamma_multiplier(&self) -> f64 { 1.0 }
    fn is_toxic_regime(&self) -> bool { false }
    fn jump_ratio(&self) -> f64 { 1.0 }
    fn momentum_bps(&self) -> f64 { 0.0 }
    fn flow_imbalance(&self) -> f64 { 0.0 }
    fn falling_knife_score(&self) -> f64 { 0.0 }
    fn rising_knife_score(&self) -> f64 { 0.0 }
    fn book_imbalance(&self) -> f64 { 0.0 }
    fn microprice(&self) -> f64 { 0.0 }
    fn beta_book(&self) -> f64 { 0.0 }
    fn beta_flow(&self) -> f64 { 0.0 }
    fn lambda_jump(&self) -> f64 { 0.01 }
    fn mu_jump(&self) -> f64 { 0.0 }
    fn sigma_jump(&self) -> f64 { 0.001 }
    fn kappa_vol(&self) -> f64 { 0.5 }
    fn theta_vol_sigma(&self) -> f64 { self.sigma }
    fn xi_vol(&self) -> f64 { 0.1 }
    fn rho_price_vol(&self) -> f64 { -0.5 }
    fn is_warmed_up(&self) -> bool { self.is_warmed }
    fn sigma_confidence(&self) -> f64 { if self.is_warmed { 1.0 } else { 0.0 } }
}
...
impl MarketEstimator for ParameterEstimator {
    fn sigma_clean(&self) -> f64 { self.sigma_clean() }
    fn sigma_total(&self) -> f64 { self.sigma_total() }
    fn sigma_effective(&self) -> f64 { self.sigma_effective() }
    fn volatility_regime(&self) -> VolatilityRegime { self.volatility_regime() }
    fn kappa(&self) -> f64 { self.kappa() }
    fn kappa_bid(&self) -> f64 { self.kappa_bid() }
    fn kappa_ask(&self) -> f64 { self.kappa_ask() }
    fn arrival_intensity(&self) -> f64 { self.arrival_intensity() }
    fn liquidity_gamma_multiplier(&self) -> f64 { self.liquidity_gamma_multiplier() }
    fn is_toxic_regime(&self) -> bool { self.is_toxic_regime() }
    fn jump_ratio(&self) -> f64 { self.jump_ratio() }
    fn momentum_bps(&self) -> f64 { self.momentum_bps() }
    fn flow_imbalance(&self) -> f64 { self.flow_imbalance() }
    fn falling_knife_score(&self) -> f64 { self.falling_knife_score() }
    fn rising_knife_score(&self) -> f64 { self.rising_knife_score() }
    fn book_imbalance(&self) -> f64 { self.book_imbalance() }
    fn microprice(&self) -> f64 { self.microprice() }
    fn beta_book(&self) -> f64 { self.beta_book() }
    fn beta_flow(&self) -> f64 { self.beta_flow() }
    fn lambda_jump(&self) -> f64 { self.lambda_jump() }
    fn mu_jump(&self) -> f64 { self.mu_jump() }
    fn sigma_jump(&self) -> f64 { self.sigma_jump() }
    fn kappa_vol(&self) -> f64 { self.kappa_vol() }
    fn theta_vol_sigma(&self) -> f64 { self.theta_vol_sigma() }
    fn xi_vol(&self) -> f64 { self.xi_vol() }
    fn rho_price_vol(&self) -> f64 { self.rho_price_vol() }
    fn is_warmed_up(&self) -> bool { self.is_warmed_up() }
    fn sigma_confidence(&self) -> f64 { self.sigma_confidence() }
}
