...
mod tests {
    ...
    fn test_quote_quality_invariants() {
        ...
        let regimes: Vec<(&str, MarketParams)> = vec![
            ("quiet", {
                MarketParams {
                    sigma: 0.0001, // Low volatility
                    sigma_effective: 0.0001,
                    kappa: 200.0, // Deep book (easy to get filled)
                    kappa_bid: 200.0,
                    kappa_ask: 200.0,
                    microprice: mid,
                    market_mid: mid,
                    arrival_intensity: 0.3,
                    ..Default::default()
                }
            }),
            ("trending", {
                MarketParams {
                    sigma: 0.0005,
                    sigma_effective: 0.0005,
                    kappa: 150.0,
                    momentum_bps: 5.0, // Moderate momentum
                    microprice: mid,
                    market_mid: mid,
            ...
            ("volatile", {
                MarketParams {
                    sigma: 0.003, // High volatility
                    sigma_effective: 0.003,
                    kappa: 80.0, // Thinner book
                    microprice: mid,
                    market_mid: mid,
            ...
            ("cascade", {
                MarketParams {
                    sigma: 0.01, // Very high volatility
                    sigma_effective: 0.01,
                    kappa: 30.0, // Very thin book
                    kappa_bid: 30.0,
                    kappa_ask: 30.0,
