...
mod tests {
    ...
    fn test_defensive_quote_degraded_model() {
        ...
        let health = ModelHealth {
            ...
            edge_calibration_ratio: 0.85, // Mid-range degradation
            ..Default::default()
        };
        ...
        match decision {
            QuoteDecision::Quote {
                ...
                assert!(
                    (0.05..=0.2).contains(&size_fraction),
    ...
    fn test_defensive_quote_size_scales_with_ratio() {
        ...
        let health_mild = ModelHealth {
            overall: Health::Degraded,
            edge_calibration_ratio: 0.7,
            ..Default::default()
        };

        // Severely degraded (ratio near 1.0) → smaller size (~0.05)
        let health_severe = ModelHealth {
            overall: Health::Degraded,
            edge_calibration_ratio: 1.0,
            ..Default::default()
        };
