...
mod tests {
    ...
    fn test_record_quote_cycle_from_integrated_signals() {
        ...
        let signals = crate::market_maker::strategy::IntegratedSignals {
            total_spread_mult: 1.05,
            combined_skew_bps: 2.0,
            signal_contributions: Some(SignalContributionRecord {
