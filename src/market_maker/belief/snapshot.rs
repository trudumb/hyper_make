...
mod tests {
    ...
    fn test_drift_vol_vol_spike_risk() {
        ...
        let mut dv = DriftVolatilityBeliefs {
            sigma_skewness: 0.5,
            ..Default::default()
        };
        assert!(!dv.has_vol_spike_risk());
    ...
    fn test_kappa_defensive_aggressive_spread() {
        let kappa = KappaBeliefs {
            spread_ci_lower_skew_adjusted: 3.0,
            spread_ci_upper_skew_adjusted: 12.0,
            ..Default::default()
        };
    ...
    fn test_kappa_recommended_spread() {
        let kappa = KappaBeliefs {
            spread_ci_lower_skew_adjusted: 4.0,
            spread_ci_upper_skew_adjusted: 10.0,
            ..Default::default()
        };
    ...
    fn test_kappa_skew_significant() {
        let mut kappa = KappaBeliefs {
            spread_ci_lower: 3.0,
            spread_ci_upper: 10.0,
            ..Default::default()
        };
